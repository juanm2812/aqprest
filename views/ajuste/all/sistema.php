	                            ...
	                            <div class="col-md-12">
			                        ...
			                        <div class="row pt-4">
										...
										<div class="col-md-6">
											<div class="form-group m-b-40">
			                                    <span class="bar"></span>
			                                    <label for="cod_seg">Comisión Tarjeta</label>
												<div class="row">
													<div class="col-8">
													<h6 class="text-muted mt-3">Se aplicara una Recargo al cobro de tarjeta obligatoria</h6>
													</div>
													<div class="col-4 text-right">
														<div class="switch">
															<label style="position: inherit;"><input type="checkbox" id="com_tar"><span class="lever switch-col-light-green"></span></label>
															<input type="hidden" name="com_tar" id="com_tar_hidden">
														</div>
													</div>
												</div>
			                                </div>											
										...
										<div class="col-md-6">
			                                <div class="form-group m-b-40 dec tar_val" style="display:none;">
			                                    <input type="text" name="com_tar_val" id="com_tar_val" class="form-control" autocomplete="off">
			                                    <span class="bar"></span>
			                                    <label for="com_tar">Valor TAR (%)</label>
			                                </div>
			                            </div>
										<div class="col-md-6">
											<div class="form-group m-b-40">
			                                    <span class="bar"></span>
			                                    <label for="cod_seg">Separar Nota de venta</label>
												<div class="row">
													<div class="col-8">
													<h6 class="text-muted mt-3">Se aplicara un forma distinto para notas de venta</h6>
													</div>
													<div class="col-4 text-right">
														<div class="switch">
															<label style="position: inherit;">
																<input type="checkbox" id="note_ticket">
																<span class="lever switch-col-light-green"></span>
															</label>
															<input type="hidden" name="note_ticket" id="note_ticket_hidden">
														</div>
													</div>
												</div>
			                                </div>											
