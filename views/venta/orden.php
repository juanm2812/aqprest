...
<input type="hidden" id="com_tar" value="<?php echo Session::get('com_tar'); ?>"/>
<br>  
<div class="row u4-1">
                        ...
                        <div class="col-md-7 p-t-20" style="background: #fbfdff;">
                            ...
                            <div class="col-lg-12 p-t-10">
                                ...
                                <div class="row">
                                    ...
                                    <?php if(Session::get('com_tar') > '0') : ?>
                                    <div class="col text-right">
                                        <div class="switch">
                                            <label style="position: inherit;"><input type="checkbox" id="com_tarj"><span class="lever switch-col-light-green"></span></label>
                                            <label for="pc_name">¿comision por tarjeta?</label>			
                                        </div>
                                    </div>
                                    <?php endif; ?>   
                                </div>
                                ...
                                <div class="input-group mt-2">
                                    ...
                                    <input type="text" class="form-control form-control-lg display-pago-tarjeta" style="width: 95px;height: 58px;border-left: 0px; border-right: 0px;" name="pago_yape" id="pago_yape" value="0.00" autocomplete="off">
                                    ...
                                    <input type="text" class="form-control form-control-lg display-pago-tarjeta" style="width: 95px;height: 58px;border-left: 0px; border-right: 0px;" name="pago_plin" id="pago_plin" value="0.00" autocomplete="off">
                                    
                                    <div class="input-group-prepend display-pago-tarjeta">
                                        <span class="input-group-text bg-white" style="display: grid; width: 60px;">
                                            <small class="text-left">TRAN</small>
                                            <div class="text-left font-medium"><?php echo Session::get('moneda'); ?></div>
                                        </span>
                                    </div>
                                    <input type="text" class="form-control form-control-lg display-pago-tarjeta" style="width: 95px;height: 58px;border-left: 0px;" name="pago_tran" id="pago_tran" value="0.00" autocomplete="off">
                                </div>                                                            
                            </div>
                            <div class="row">
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="switch">
                                    <span class="mr-2 display_venta_por_consumo">  
                                        <input type="checkbox" name="venta_por_consumo" id="venta_por_consumo" class="material-inputs filled-in chk-col-blue venta_por_consumo"/>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content animated bounceInTop">
            ...
            <div class="modal-header justify-center">
                ...
                <div class="ml-auto m-t-10 opcion-cliente-dni-ruc"  style="display: none;">
    ...
    <tr class="warning-element" style="border-left: 2px solid #ffb22b !important; background: #fefde3;">
        <td style="padding: 5px 14px;">
            <div class="row">
                ...
                <div class="col-8 col-md-8 col-lg-8 col-xl-8 text-right" style="font-size:14px;  ">
            ...
            <div class="row mt-1">
                ...
                <div class="col-8 col-md-8 col-lg-8 col-xl-8 text-right">
                    <?php
                    if (Session::get('editarprecio')==1) { ?>
                        <button type="button" class="btn btn-sm waves-effect waves-light btn-outline-info" onclick="preciolist({{:id}});"><i class="fas fa-edit"></i></button>
                    <?php } ?>
                    ...
                    <input type="hidden" name="comentario" class="nota{{:id}}" value="" onchange="pedido.actualizar({{:id}}, this);">
                </div>
            </div>
        </td>
    </tr>
