...
foreach($this->dato->Pagos as $d){ 
	...
	$pdf->Cell(40, 4, number_format(($d->MONTO),2),0,0,'R');
	$pdf->Ln(4);
}

// if($this->dato->Credito->total > 0){
// $pdf->Cell(47, 4, ' - YAPE',0);   
// $pdf->Cell(25, 4, number_format((20),2),0,0,'R');
// $pdf->Ln(4);
// $pdf->Cell(47, 4, ' - PLIN',0);   
// $pdf->Cell(25, 4, number_format((20),2),0,0,'R');
// $pdf->Ln(4);
// $pdf->Cell(47, 4, ' - YAPE',0);   
// $pdf->Cell(25, 4, number_format((20),2),0,0,'R');
...
$pdf->Ln(4); 
$pdf->Cell(32, 4, 'COMISION DE TARJETA', 0);
$pdf->Cell(15, 4, $this->dato->ComisionTarjeta->cant,0,0,'R');
$pdf->Cell(25, 4, number_format(($this->dato->ComisionTarjeta->total),2),0,0,'R');
