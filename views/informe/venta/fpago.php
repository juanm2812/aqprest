        ...
        <div class="card">
            ...
            <div class="text-center m-b-20">
                <div class="row text-center">
                    ...
                    <div class="col com_tars" style="display:none;">
                        <h2 class="font-medium text-warning m-b-0 font-30 comision-total"></h2>
                        <h6 class="font-bold m-b-10">Comisión Tarjeta</h6>
                    </div>
                    <div class="col">
                    ...
                    <table id="table" class="table table-hover table-condensed stylish-table" width="100%">
                        <thead class="table-head">
                            <tr>
                                ...
                                <th width="15%">Comision tarjeta</th>
                                <th class="text-right" width="10%">Tipo de Pago</th>
                                <th class="text-right" width="10%">Total venta</th>
                            </tr>
                        </thead>
