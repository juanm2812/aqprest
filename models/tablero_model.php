	...
	public function tablero_datos()
    {
        try
        {
            ...
            */
            ...
            $sql_canal_salon = $this->db->prepare("SELECT COUNT(*) AS cantidad_ventas, SUM(pago_efe + pago_tar+ pago_yape + pago_plin + pago_tran) total_ventas FROM tm_venta WHERE id_tipo_pedido = 1 AND estado = 'a' AND id_apc = ?");
