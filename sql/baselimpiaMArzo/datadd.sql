...
--
-- Host: localhost    Database: restopos
-- ------------------------------------------------------
...
INSERT INTO `tm_area_prod` VALUES (1,6,'COCINA','a'),(2,3,'BAR','a'),(3,3,'BAR2','a'),(4,1,'PARILLA','a');
...
INSERT INTO `tm_cliente` VALUES (1,1,'00000000','','PUBLICO EN GENERAL','',0,'1970-01-01','','-','','a'),(29,1,'00000000','','JM','',945458847,'0000-00-00','','AV PERU 1383 CATAC','JM','a'),(30,2,'','20605512098','','GRUPO INSAGA S.A.C.',0,'1970-01-01','','AV. T. AMARU NRO. 530 URB. C.M. PRADO, LIMA - LIMA - COMAS','','a'),(31,2,'','10476331213','','CASTILLO GAMARRA JUAN MANUEL',0,'1970-01-01','','AV. 31 DE MAYO NRO. 1386 CENTRO CATAC, ANCASH - RECUAY - CATAC','','a'),(32,2,'','20131370301','','MINISTERIO PUBLICO-GERENCIA GENERAL',0,'1970-01-01','','AV. ABANCAY NRO. 491, LIMA - LIMA - LIMA','','a');
/*!40000 ALTER TABLE `tm_cliente` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tm_comandas`
--

DROP TABLE IF EXISTS `tm_comandas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tm_comandas` (
...
--
-- Dumping data for table `tm_comandas`
--

LOCK TABLES `tm_comandas` WRITE;
/*!40000 ALTER TABLE `tm_comandas` DISABLE KEYS */;
INSERT INTO `tm_comandas` VALUES (3,'2023-02-12 19:40:27','0dff1b3b9a5c6ede6a490964e704ece3'),(4,'2023-02-12 19:41:50','bdb3798f765f9efafd0bd0dc75d3cd62'),(4,'2023-02-13 23:24:48','d1fcb7e4a3a3744ceb245b13b9d6be77'),(1,'2023-02-13 23:37:32','e08b8fa0985793b1c1fe3da196c39ad8'),(2,'2023-02-13 23:46:44','6f01739ee99e64776bb61c2b13b04904'),(3,'2023-02-13 23:47:00','fa70d5a157088261d5eb4cc3214c15e0'),(4,'2023-02-14 17:34:31','5d65ec929754547febe1f4f236de7165'),(5,'2023-02-14 17:35:31','1733c31ac4eb3d2725d7f71fa106fee9'),(7,'2023-02-14 17:45:02','0010e30b84ea84f9ae2aabcdc3628fd7'),(8,'2023-02-14 17:51:23','e850ad377068d911fa7eb566cd57705d'),(9,'2023-02-14 17:52:42','6eb1ba8f490163fc7cf8031bd94c6386'),(10,'2023-02-14 17:54:23','51b18c928767181d056c65f1d9ff35e6'),(11,'2023-02-14 18:00:21','9969c0bc5a4a4c575bed13816370026c'),(12,'2023-02-14 18:09:55','798cac163af34ecce8361b45d2d4eb75'),(13,'2023-02-14 18:10:22','207414c3a41efab9eded97cff9030a53'),(14,'2023-02-14 18:19:39','95b3a4add9812a593feebf1d93b1aabd'),(15,'2023-02-14 18:21:31','2f8ceebe3809245e3b454cd2691f7589'),(6,'2023-02-14 18:54:35','5ae59578fa4ce406b244b60ccbf8f5e4'),(6,'2023-02-14 18:55:08','c9e84a12516f4b10f7e6e890
','65241dae310a1c6125f2b79c9a963e20'),(3,'2023-03-08 17:01:10','d4d9c2ab75b73ce6763347e1bce15a58'),(4,'2023-03-08 17:02:13','39bd18593051c50f7e93c3295e2ed001'),(5,'2023-03-08 17:02:36','6c2ea16ca5b11e0166a3efdbcd30e20f'),(6,'2023-03-08 17:04:05','02214d75f8bc5deb4caaf8d290062d8b'),(6,'2023-03-08 17:08:02','2d1ecbeb051a489bfd6eb304bc085217');
/*!40000 ALTER TABLE `tm_comandas` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tm_configuracion` (
  ...
  `com_tar` int(1) NOT NULL DEFAULT 0,
  `com_tar_val` int(11) NOT NULL DEFAULT 0,
  `note_ticket` int(1) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id_cfg`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tm_configuracion` VALUES (1,'America/Lima','RUC',11,'DNI',8,'IGV',18.00,'Soles','S/','LAPTOP-1HMNQJFG','192.168.100.20',0,0,0,1,0,1,NULL,'123456','{\"created_at\":\"11-02-2023\",\"limit_users\":\"22\",\"locked_users\":\"\",\"limit_documents\":\"1000\",\"locked_documents\":\"1\"}',1,10,1);
...
INSERT INTO `tm_empresa` VALUES (1,'20601629284','RUSTICA CLUB S.A.C.','','AV. SAN MARTIN 134 ','AV. TINGO MARIA NRO. 857 URB. CHACRA RIOS NORTE, LIMA - LIMA - BREÑA','150132','LIMA','LIMA','BREÑA',1,3,'moddatos','moddatos','sistemas10','','','logoprint.png','','',0,'',0);
...
INSERT INTO `tm_impresora` VALUES (1,'NINGUNO','a'),(2,'CAJA','a'),(3,'BAR','a'),(6,'COCINA','a');
...
INSERT INTO `tm_mesa` VALUES (1,1,'01',1,'a'),(2,1,'01',1,'a'),(3,1,'03',1,'a');
...
INSERT INTO `tm_producto_catg` VALUES (1,'COMBOS',0,0,'default.png','a');
...
INSERT INTO `tm_repartidor` VALUES (1,'INTERNO','a'),(2222,'RAPPI','a'),(3333,'UBER','a'),(4444,'GLOVO','a');
...
INSERT INTO `tm_salon` VALUES (1,'SALON','a');
...
INSERT INTO `tm_tipo_doc` VALUES (1,'BOLETA DE VENTA','BA01','00000001','a',1),(2,'FACTURA','FA01','00000001','a',0),(3,'NOTA DE VENTA','NV01','00000001','a',0);
...
INSERT INTO `tm_turno` VALUES (1,'PRIMER TURNO'),(2,'SEGUNDO TURNO');
...
INSERT INTO `tm_usuario` VALUES (1,1,0,'44827499','ADMINISTRADOR','ADMINISTRADOR','ADMINISTRADOR','administrador@gmail.com','administrador','c29wb3J0ZTI=','a','161117020710-avatar5.png',0,NULL,NULL),(44,5,1,'77777777','CABANA','CASTILLO GAMARRA','ANGEL CAVIR','juanm2812@gmail.com','20','MjA=','a','default-avatar.png',1,NULL,NULL);
...
/*!50001 CREATE TABLE `v_ventas_con` (
  ...
  `pago_yape` tinyint NOT NULL,
  `pago_plin` tinyint NOT NULL,
  `pago_tran` tinyint NOT NULL,
  ...
  `consumo_desc` tinyint NOT NULL,
  `desc_usu` tinyint NOT NULL
) ENGINE=MyISAM */;
SET character_set_client = @saved_cs_client;

--
-- Dumping routines for database 'restopos'
--
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE  PROCEDURE `usp_configMesas`(
...
BEGIN
	...
	IF _flag = 2 THEN
		...
		SELECT COUNT(*) INTO _filtro FROM tm_mesa WHERE id_salon = _id_salon AND nro_mesa = _nro_mesa AND estado = _estado AND  forma = _forma;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `usp_restEmitirVenta`(
	`_flag` INT(11),
	`_dividir_cuenta` INT(11),
	`_id_pedido` INT(11),
	`_tipo_pedido` INT(11),
	`_tipo_entrega` VARCHAR(1),
	`_id_cliente` INT(11),
	`_id_tipo_doc` INT(11),
	`_id_tipo_pago` INT(11),
	`_id_usu` INT(11),
	`_id_apc` INT(11),
	`_pago_efe_none` DECIMAL(10,2),
	`_pago_tar` DECIMAL(10,2),
	`_pago_yape` DECIMAL(10,2),
	`_pago_plin` DECIMAL(10,2),
	`_pago_tran` DECIMAL(10,2),
	`_descuento_tipo` CHAR(1),
	`_descuento_personal` INT(11),
	`_descuento_monto` DECIMAL(10,2),
	`_descuento_motivo` VARCHAR(200),
	`_comision_tarjeta` DECIMAL(10,2),
	`_comision_delivery` DECIMAL(10,2),
	`_igv` DECIMAL(10,2),
	`_total` DECIMAL(10,2),
	`_codigo_operacion` VARCHAR(20),
...
BEGIN
	...
	IF _flag = 1 THEN
		...
		VALUES (_id_pedido, _tipo_pedido, _id_cliente, _id_tipo_doc, _id_tipo_pago,_id_usu,_id_apc, @serie,@numero, pago_efe, _pago_efe_none, pago_tar, _pago_yape, _pago_plin, _pago_tran, _descuento_tipo, _descuento_personal, _descuento_monto, _descuento_motivo, _comision_tarjeta, _comision_delivery, _igv, _total, _codigo_operacion, _fecha_venta );
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013  SQL SECURITY DEFINER */
/*!50001 VIEW `v_listar_mesas` AS select `vm`.`id_mesa` AS `id_mesa`,`vm`.`id_salon` AS `id_salon`,`vm`.`nro_mesa` AS `nro_mesa`,`vm`.`estado` AS `estado`,`vm`.`desc_salon` AS `desc_salon`,`vm`.`forma` AS `forma`,`vo`.`id_pedido` AS `id_pedido`,`vo`.`fecha_pedido` AS `fecha_pedido`,`vo`.`nro_personas` AS `nro_personas` from (`v_mesas` `vm` left join `v_pedido_mesa` `vo` on(`vm`.`id_mesa` = `vo`.`id_mesa`)) order by `vm`.`nro_mesa` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013  SQL SECURITY DEFINER */
/*!50001 VIEW `v_mesas` AS select `m`.`id_mesa` AS `id_mesa`,`m`.`id_salon` AS `id_salon`,`m`.`nro_mesa` AS `nro_mesa`,`m`.`forma` AS `forma`,`m`.`estado` AS `estado`,`cm`.`descripcion` AS `desc_salon` from (`tm_mesa` `m` join `tm_salon` `cm` on(`m`.`id_salon` = `cm`.`id_salon`)) where `m`.`id_mesa` <> 0 and `cm`.`estado` <> 'i' order by `m`.`id_mesa` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2023-03-08 17:25:07
